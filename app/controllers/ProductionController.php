<?php
class ProductionController extends MsController{
    ...
    public function actionView(){
        ...
        $this->render('view',true,true); //подключаем фаил отображения и передаём ему массив данных
   	}
    ...
    public function actionIndex(){
        ...
        $data->parser = $this->params; //добавляем параметры переданные парсером
        $this->data = $data; //пишем в свойство для использования из файла отображения
        $this->render('index',true,true); //подключаем фаил отображения и передаём ему массив данных (true - включаем левый сайдбар)
   	}
    ...
    public function actionAll(){
        ...
        $data->parser = $this->params; //добавляем параметры переданные парсером
        $this->data = $data; //пишем в свойство для использования из файла отображения
        $this->render('index',true,true); //подключаем фаил отображения и передаём ему массив данных
   	}
